...
- [Chapter 3　基本的な回帰とモデルのチェック](#chapter-3基本的な回帰とモデルのチェック)
  - [3.1　単回帰](#31単回帰)
  - [3.2　重回帰](#32重回帰)
  - [3.3　二項ロジスティック回帰](#33二項ロジスティック回帰)
  - [3.4　ロジスティック回帰](#34ロジスティック回帰)
  - [3.5　ポアソン回帰](#35ポアソン回帰)
  - [3.6　モデルチェックのまとめ](#36モデルチェックのまとめ)
  - [3.7　補足と文献案内](#37補足と文献案内)
...
| 節 | モデル | 感染症分野での例 |
|---|---|---|
| 3.1 | 単回帰 | 下水中ウイルスRNA濃度と地域感染者率 |
| 3.2 | 重回帰 | 入院率と症例数、ワクチン接種率、移動量 |
| 3.3 | 二項ロジスティック回帰 | 検査陽性数 / 検査数、検査陽性率 |
| 3.4 | ロジスティック回帰 | 個人単位の感染有無、ワクチン接種、曝露 |
| 3.5 | ポアソン回帰 | 地域別・週別症例数、人口オフセット |
